...
Ninety-one formal Divine Seats now exist, with seven fragmentary names or groups preserved in the Silent Gallery. The Greek collection has grown into a fourteen-seat network, the Vedic into a ten-seat network, and the Norse collection now holds thirteen seats — organized around succession and local cult, wine and mystery cult; hymn, sacrifice, cosmic order, and the roads of the dead; and knowledge, constraint, exchange, and Ragnarök. They are no longer mere samples standing in for Zeus/Athena, Odin/Thor, or Indra/Agni.
